...
public class ReceptMainWindowController {
    ...
    public Button btncrtbckg;
    public Button btncnslbckg;
    ...
    private void setResetButtonColourBlue(){
        ...
        btncrtbckg.setStyle(notclickedcolourblue);
        btncnslbckg.setStyle(notclickedcolourblue);
    }
    ...
    public void onActionPlaceBookngSceneButton(ActionEvent actionEvent) throws IOException {
        setResetButtonColourBlue();
        btncrtbckg.setStyle(clickedcolourblue);
        setScene("CreateBookingScene");
    }
    ...
    public void OnActionbtnCnslBookng(ActionEvent actionEvent) throws IOException {
        setResetButtonColourBlue();
    ...
    public void onActionFirstimgcrtbkg(MouseEvent mouseEvent) throws IOException {
        setResetButtonColourBlue();
        btncrtbckg.setStyle(clickedcolourblue);
        setScene("CreateBookingScene");
    }
